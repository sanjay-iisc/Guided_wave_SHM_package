...
for nFreq in np.arange(100, 1000, 500)*1e3:
    ...
    path="E:\Work\Work\\Nicolas_opti_results_2\ZZ\\"+"F_"+str(int(nFreq*1e-3))+'_KHz'
    GA.GeneticAlgorithm_Base._get_userInputs(demo_func,dim=4,max_intr=5,population_size=1000,dir_name_save=path)
    # # print('sa'
