...
varbound=np.array([[-200,200],[-2,2],[0,1],[-2,2]])#,[-100,100],[0,1]])
...
model=ga(function=demo_func,dimension=4,variable_type='real',variable_boundaries=varbound,algorithm_parameters=algorithm_param)
