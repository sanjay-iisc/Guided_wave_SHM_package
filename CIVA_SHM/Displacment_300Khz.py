...
Hm_CS_10=CIVA_simulation("E:\Work\Work\\Nicolas_Simulation\\HM_optimized_stress\_07062021_input_HM_opt_stress_300khz_10Dis.civa\\proc0\\result\Displacement\\")
#_30052021_200khz_PF_input_FEM_stress_10discretized.civa\\proc0\\result\Displacement\\")
Hm_U_10=Hm_CS_10.Displacement()
Hm_CS_10.HT()

CS_10=CIVA_simulation("E:\Work\Work\\Nicolas_Simulation\\HM_FEMstress\_04062021_300khz_input_FEM_stress_10discretized.civa\\proc0\\result\Displacement\\")
U_10=CS_10.Displacement()
CS_10.HT()


PF_CS_10=CIVA_simulation("E:\Work\Work\\Nicolas_Simulation\\PF\_02062021_300khz_PF_imput_stress_4dis.civa\\proc0\\result\Displacement\\")
#_30052021_200khz_PF_input_FEM_stress_10discretized.civa\\proc0\\result\Displacement\\")
PF_U_10=PF_CS_10.Displacement()
PF_CS_10.HT()

CS_4=CIVA_simulation("E:\Work\Work\\Nicolas_Simulation\\HM_FEMstress\_04062021_300khz_input_FEM_stress_4discretized.civa\\proc0\\result\Displacement\\")
U_4=CS_4.Displacement()
CS_4.HT()


CFE=FEM("K:\LMC\Sanjay\\Comsolresults\\NicolasResults\\TimeDomain\Results_125mm\\Displacments_at25mm_0.3_Mhz.csv")
CFE.Displacement()
...
plt.plot(U_10[0],U_10[1]*1e-3, label='CIVA-Direct Stress D=10', c='r')
...
plt.plot(Hm_U_10[0],Hm_U_10[1]*1e-3/ (5), label='CIVA-HM D=10', c='g')
...
plt.savefig(path_save+'\\'+'Urr300khz.png')
#----------------------------Time Freq---Urr
plt.figure()
...
plt.plot(U_10[0],U_10[2]*1e-3, label='CIVA-Direct Stress D=10', c='r')
...
plt.plot(Hm_U_10[0],Hm_U_10[2]*1e-3/ (5), label='CIVA-HM D=10', c='g')
...
plt.legend()
plt.xlim([0,30])
plt.savefig(path_save+'\\'+'Uzz300khz.png')
