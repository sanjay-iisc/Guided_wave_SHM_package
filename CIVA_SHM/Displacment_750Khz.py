...
Hm_CS_10=CIVA_simulation("E:\Work\Work\\Nicolas_Simulation\\HM_optimized_stress\_07062021_input_HM_opt_stress_750khz_1Dis.civa\\proc0\\result\Displacement\\")
#_30052021_200khz_PF_input_FEM_stress_10discretized.civa\\proc0\\result\Displacement\\")
Hm_U_10=Hm_CS_10.Displacement()
Hm_CS_10.HT()

CS_10=CIVA_simulation("E:\Work\Work\\Nicolas_Simulation\\HM_FEMstress\\_04062021_750khz_input_FEM_stress_4discretizet_FS25_20Cycle.civa\\proc0\\result\Displacement\\")
U_10=CS_10.Displacement()
CS_10.HT()


PF_CS_10=CIVA_simulation("E:\Work\Work\\Nicolas_Simulation\\PF\_02062021_750khz_PF_imput_stress_4dis.civa\\proc0\\result\Displacement\\")
#_30052021_200khz_PF_input_FEM_stress_10discretized.civa\\proc0\\result\Displacement\\")
PF_U_10=PF_CS_10.Displacement()
PF_CS_10.HT()

CS_1=CIVA_simulation("E:\Work\Work\\Nicolas_Simulation\\HM_FEMstress\_04062021_750khz_input_FEM_stress_1discretizet.civa\\proc0\\result\Displacement\\")
U_1=CS_1.Displacement()
CS_1.HT()


CFE=FEM("K:\LMC\Sanjay\\Comsolresults\\NicolasResults\\TimeDomain\Results_125mm\\DisplacmentsRR_upper_at25mm_0.75_Mhz.csv")
CFE.Displacement()
UFEM=[CFE.getValue(0),np.real(CFE.getValue(1).str.replace('i','j').apply(lambda x: np.complex128(x))) ]
CFE.HT(UFEM)
#---Line Load
CFE_LL=FEM("K:\LMC\Sanjay\\Comsolresults\\NicolasResults\\TimeDomain\Results_125mm\\DisplacmentsZZ_upper_at25mm_0.75_Mhz.csv")
CFE_LL.Displacement()
UFEM_LL=[CFE_LL.getValue(0),np.real(CFE_LL.getValue(1).str.replace('i','j').apply(lambda x: np.complex128(x)))]
CFE_LL.HT(UFEM_LL)
#---- Reading the Time History
TimeHis=pd.read_csv("E:\Work\Work\\Nicolas_Simulation\CivaFile\\TimeHistory0.75.csv").T
...
plt.plot(U_10[0],U_10[1]*1e-3, label='CIVA-Direct Stress D=2', c='r')
plt.plot(U_10[0],CS_10.U_HT_amp[0]*1e-3,c='r', linestyle='--')
plt.plot(U_1[0],U_1[1]*1e-3, label='CIVA-Direct Stress D=1', c='g')
plt.plot(U_1[0],CS_1.U_HT_amp[0]*1e-3,c='r', linestyle='--')

plt.plot(PF_U_10[0],PF_U_10[1]*1e-3, c='k', linestyle='-', label ='PF D=4')
plt.plot(PF_U_10[0],PF_CS_10.U_HT_amp[0]*1e-3,c='k', linestyle='--')

# plt.plot(Hm_U_10[0],Hm_U_10[1]*1e-3/ (5), label='CIVA-HM D=1', c='g')
...
plt.savefig(path_save+'\\'+'Urr750khz.png')
#----------------------------Time Freq---Urr
plt.figure()
...
plt.title('Freq @ 750KHz- Time Frequency-Urr ')
plt.legend()
plt.grid()
...
plt.plot(U_10[0],U_10[2]*1e-3, label='CIVA-Direct Stress D=2', c='r')
plt.plot(U_10[0],CS_10.U_HT_amp[1]*1e-3,c='r', linestyle='--')

plt.plot(U_1[0],U_1[2]*1e-3, label='CIVA-Direct Stress D=1', c='g')
plt.plot(U_1[0],CS_1.U_HT_amp[1]*1e-3,c='r', linestyle='--')

plt.plot(PF_U_10[0],PF_U_10[2]*1e-3, c='k', linestyle='-', label ='PF D=4')
plt.plot(PF_U_10[0],PF_CS_10.U_HT_amp[1]*1e-3,c='k', linestyle='--')

# plt.plot(Hm_U_10[0],Hm_U_10[2]*1e-3/ (5), label='CIVA-HM D=1', c='g')
# plt.plot(Hm_U_10[0],(Hm_CS_10.U_HT_amp[1]*1e-3)/5,c='g', linestyle='--')

plt.plot(UFEM_LL[0]*1e6,UFEM_LL[1] , label='FEM', c='b', marker='None', markersize=2, linestyle='-')
# plt.plot(UFEM_LL[0]*1e6,UFEM_LL.U_HT_amp[0],c='b', linestyle='--')
...
plt.legend()
# plt.xlim([0,30])
plt.savefig(path_save+'\\'+'Uzz750khz.png')
...
# plt.xlabel('Time[micro sec]')
# plt.ylabel(r'$Freq[MHZ]$')
# plt.title('Freq @ 300KHz- Time Frequency-Uzz ')
# plt.legend()
# plt.grid()
